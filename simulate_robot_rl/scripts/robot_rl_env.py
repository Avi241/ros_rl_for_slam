...
file_path = __file__
dir_path = file_path[:(len(file_path) - len('robot_rl_env.py'))] + 'config/'
...
MAX_ACTION_NUM = 3
MAX_MAP_COMPLETENESS = 11.
MAX_STEPS = rospy.get_param('rlslam/steps_in_episode')
CRASH_COUNT_THRESH = rospy.get_param('rlslam/crash_count_thresh')
